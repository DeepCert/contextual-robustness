...
def main(models, transform_names, outdir, sample_indexes, image_formats):
    ...
    for transform in transform_names:
        ...
        for m in models:
            ...
            cr.load_results(
                epsilons_path=os.path.join('./results/gtsrb/formal/data', f'model{m}-{transform}.csv'),
                counterexamples_path=os.path.join('./results/gtsrb/formal/data', f'model{m}-{transform}-counterexamples.p')
                )
...
if __name__ == '__main__':
    ...
    parser.add_argument('-o', '--outdir',
        default='./results/gtsrb/formal/images',
